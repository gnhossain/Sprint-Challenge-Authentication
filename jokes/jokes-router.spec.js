...
describe('jokes', function(){
     describe('GET /api/jokes', function(){
          it('should return error if no credentials', function(){
...
describe('jokes', () => {
   it('requires authorization to get status code 200', () => {
               ...
               Users.add({username:"user0", password:"uuuu"})
               request(server).post('/api/auth/login').send({ username: "user0", password: "uuuu"}).then(res => {
               loginResponse = res
